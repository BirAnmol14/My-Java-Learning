...
public class BankAccount {
    ...
    public BankAccount(double initialBalance, int accountNumber) {
        ...
        if(accountNumber<10000||accountNumber>99999) {
        	throw new IllegalArgumentException("Enter a valid 5 digit-account number");
        }
    ...
    public void withdraw(double amount) throws InsufficientFundsException{
        ...
        if(amount>balance) {
        	throw new InsufficientFundsException("Insufficient funds, withdraw less than: "+balance);
        }
        balance = balance - amount;
    }
